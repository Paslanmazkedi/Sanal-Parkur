...
export default function Dashboard() {
  ...
  return (
    <div className="mx-auto w-full min-w-0 max-w-6xl space-y-6 md:space-y-8">
      <header>
        <h1 className="text-2xl font-black tracking-tight text-white sm:text-3xl md:text-4xl">Entegrasyon Kontrol Paneli</h1>
        <p className="mt-2 text-sm text-slate-400">Entegrasyon katmanı ile akıllı fabrikadan gelen eşzamanlı verilerin yönetim konsolu.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-900/60 border border-slate-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl hover:border-sky-500/20 transition-all duration-300 group">
          ...
          <div className="text-3xl font-black mt-3 text-white tracking-tight group-hover:translate-x-1 transition-transform duration-200 sm:text-4xl">{stats.orders} <span className="text-sm font-normal text-slate-500">Adet</span></div>
        </div>
        <div className="bg-slate-900/60 border border-slate-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl hover:border-purple-500/20 transition-all duration-300 group">
          ...
          <div className="text-3xl font-black mt-3 text-white tracking-tight group-hover:translate-x-1 transition-transform duration-200 sm:text-4xl">{stats.assets} <span className="text-sm font-normal text-slate-500">Cihaz</span></div>
        </div>
        <div className="bg-slate-900/60 border border-slate-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl hover:border-emerald-500/20 transition-all duration-300 group">
          ...
          <div className="text-3xl font-black mt-3 text-emerald-400 tracking-tight group-hover:translate-x-1 transition-transform duration-200 sm:text-4xl">{stats.operations} <span className="text-sm font-normal text-slate-500 text-slate-400">Kayıt</span></div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 shadow-2xl backdrop-blur-sm">
        ...
        <div className="w-full min-w-0 overflow-x-auto rounded-xl border border-slate-800/60 bg-black/20">
          <table className="min-w-[40rem] w-full text-left text-xs text-slate-400 border-collapse">
